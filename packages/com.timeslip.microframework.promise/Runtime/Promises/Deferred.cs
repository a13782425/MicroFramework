        ...
        public readonly struct DeferredBase : ICancelable, IEquatable<DeferredBase>
        {
            ...
            public Promise Promise
            {
                ...
                get
                {
                    ...
                    if (_this == null)
                    {
                        throw new PromiseInvalidOperationException("DeferredBase.Promise: instance is not valid.", Internal.GetFormattedStacktrace(1));
                    }
#endif
            ...
            /// </summary>
            /// <exception cref="PromiseInvalidOperationException"/>
            public void Reject<TReject>(TReject reason)
            {
                var _this = _ref;
                if (_this?.TryIncrementDeferredId(_deferredId) != true)
                {
                    throw new PromiseInvalidOperationException("DeferredBase.Reject: instance is not valid or already complete.", Internal.GetFormattedStacktrace(1));
                }
            ...
            public void Cancel()
            {
                ...
                if (_this?.TryIncrementDeferredId(_deferredId) != true)
                {
                    throw new PromiseInvalidOperationException("DeferredBase.Cancel: instance is not valid or already complete.", Internal.GetFormattedStacktrace(1));
                }
                _this.CancelDirect();
            }
        ...
        public readonly struct Deferred : ICancelable, IEquatable<Deferred>
        {
            ...
            public Promise Promise
            {
                ...
                get
                {
                    ...
                    if (_this == null)
                    {
                        throw new PromiseInvalidOperationException("Deferred.Promise: instance is not valid.", Internal.GetFormattedStacktrace(1));
                    }
#endif
            ...
            public void Resolve()
            {
                ...
                if (_this?.TryIncrementDeferredId(_deferredId) != true)
                {
                    throw new PromiseInvalidOperationException("Deferred.Resolve: instance is not valid or already complete.", Internal.GetFormattedStacktrace(1));
                }
            ...
            public void Reject<TReject>(TReject reason)
            {
                ...
                if (_this?.TryIncrementDeferredId(_deferredId) != true)
                {
                    throw new PromiseInvalidOperationException("Deferred.Reject: instance is not valid or already complete.", Internal.GetFormattedStacktrace(1));
                }
                _this.RejectDirect(Internal.CreateRejectContainer(reason, 1, null, _this));
            }
            ...
            public void Cancel()
            {
                ...
                if (_this?.TryIncrementDeferredId(_deferredId) != true)
                {
                    throw new PromiseInvalidOperationException("Deferred.Cancel: instance is not valid or already complete.", Internal.GetFormattedStacktrace(1));
                }
                _this.CancelDirect();
            }
