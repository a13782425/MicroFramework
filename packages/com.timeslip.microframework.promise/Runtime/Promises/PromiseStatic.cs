...
namespace MFramework.Core.Promise
{
    public partial struct Promise
    {
        ...
        public static PromiseSwitchToContextAwaiter SwitchToForegroundAwait(bool forceAsync = false)
        {
            ...
            if (context == null)
            {
                throw new PromiseInvalidOperationException("Promise.Config.ForegroundContext is null. You should set Promise.Config.ForegroundContext at the start of your application" +
        ...
        /// <summary>
        /// Get a <see cref="PromiseRethrowException"/> that can be thrown inside an onRejected callback to rethrow the caught rejection, preserving the stack trace.
        /// This should be used as "throw Promise.Rethrow;"
        /// This is similar to "throw;" in a synchronous catch clause.
        /// </summary>
        public static PromiseRethrowException Rethrow
            => PromiseRethrowException.GetOrCreate();

        /// <summary>
        /// Get a <see cref="PromiseCanceledException"/> that can be thrown to cancel the promise from an onResolved or onRejected callback, or in an async Promise function.
        /// This should be used as "throw Promise.CancelException();"
        /// </summary>
        public static PromiseCanceledException CancelException()
        ...
        /// </summary>
        public static PromiseRejectException RejectException<T>(T value)
