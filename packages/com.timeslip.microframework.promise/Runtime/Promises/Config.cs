...
namespace MFramework.Core.Promise
{
    partial struct Promise
    {
        ...
        public static class Config
        {
            ...
            /// </remarks>
            public static Action<PromiseUnhandledException> UncaughtRejectionHandler
            {
                [MethodImpl(Internal.InlineOption)]
            ...
            private static Action<PromiseUnhandledException> s_uncaughtRejectionHandler;
            ...
            private static void ThrowCannotDisableAsyncFlow()
                => throw new PromiseInvalidOperationException("Cannot disable AsyncFlowExecutionContext. It may only be enabled.");
        }
    }
}