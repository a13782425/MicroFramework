...
namespace MFramework.Core.Promise
{
    partial class Internal
    {
...
#endif
        internal sealed class UnhandledExceptionInternal : PromiseUnhandledException, IRejectContainer, IRejectionToContainer, ICantHandleException
        {
        ...
        [DebuggerNonUserCode, StackTraceHidden]
#endif
        internal sealed class CanceledExceptionInternal : PromiseCanceledException
        {
        ...
        [DebuggerNonUserCode, StackTraceHidden]
#endif
        internal sealed class RejectExceptionInternal : PromiseRejectException, IRejectionToContainer, ICantHandleException
        {
