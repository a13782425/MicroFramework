    ...
    partial class Internal
    {
        ...
        private static class CollectionChecker<T> where T : class, ILinked<T>
        {
            ...
            internal static void AssertNotInCollection(T item, TraceableCollection newCollection)
            {
                ...
                Exception innerException = currentCollection.createdAt == null ? null : new PromiseInvalidOperationException("Inhabited collection createdAt stacktrace.", currentCollection.createdAt.ToString());
