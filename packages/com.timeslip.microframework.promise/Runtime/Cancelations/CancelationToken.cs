...
namespace MFramework.Core.Promise
{
    ...
    public readonly partial struct CancelationToken : IEquatable<CancelationToken>
    {
        ...
        /// <summary>
        /// If cancelation was requested on this token, throws a <see cref="PromiseCanceledException"/>.
        /// </summary>
        /// <exception cref="PromiseCanceledException"/>
        ...
        public void Release()
        {
            ...
            {
                throw new PromiseInvalidOperationException("CancelationToken.Release: you must call Retain before you call Release.", Internal.GetFormattedStacktrace(1));
            }
        }
