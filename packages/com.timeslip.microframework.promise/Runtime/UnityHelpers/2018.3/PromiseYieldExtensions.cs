...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        /// Gets an awaiter wrapping the <paramref name="awaitInstruction"/>, with cancelation.
        /// </summary>
        public static AwaitInstructionAwaiter<TAwaitInstruction> WithCancelation<TAwaitInstruction>(this TAwaitInstruction awaitInstruction, GameObject obj)
            where TAwaitInstruction : IAwaitInstruction
            => new AwaitInstructionAwaiter<TAwaitInstruction>(awaitInstruction, obj.GetCancelationToken());

        /// <summary>
        /// Gets an awaiter wrapping the <paramref name="awaitInstruction"/>, with cancelation.
        /// </summary>
        public static AwaitInstructionAwaiter<TAwaitInstruction> WithCancelation<TAwaitInstruction>(this TAwaitInstruction awaitInstruction, MonoBehaviour mono)
            where TAwaitInstruction : IAwaitInstruction
            => new AwaitInstructionAwaiter<TAwaitInstruction>(awaitInstruction, mono.GetCancelationToken());
        ...
        /// Converts the <paramref name="awaitInstruction"/> to a <see cref="Promise"/>.
        /// </summary>
        public static Promise ToPromise<TAwaitInstruction>(this TAwaitInstruction awaitInstruction, GameObject obj)
            where TAwaitInstruction : IAwaitInstruction
            => new AwaitInstructionAwaiter<TAwaitInstruction>(awaitInstruction, obj.GetCancelationToken()).ToPromise();

        /// <summary>
        /// Converts the <paramref name="awaitInstruction"/> to a <see cref="Promise"/>.
        /// </summary>
        public static Promise ToPromise<TAwaitInstruction>(this TAwaitInstruction awaitInstruction, MonoBehaviour mono)
            where TAwaitInstruction : IAwaitInstruction
            => new AwaitInstructionAwaiter<TAwaitInstruction>(awaitInstruction, mono.GetCancelationToken()).ToPromise();
