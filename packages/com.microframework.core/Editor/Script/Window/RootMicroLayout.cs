...
namespace MFramework.Core.Editor
{
    internal class RootMicroLayout : BaseMicroLayout
    {
        ...
        {
            var classElement = new MicroClassElement(null, null, typeof(IMicroModule), _classGroup);
        ...
        {
            return arg.GetCustomAttribute<IgnoreAttribute>() == null && !arg.IsAbstract && !arg.IsInterface;
        }
