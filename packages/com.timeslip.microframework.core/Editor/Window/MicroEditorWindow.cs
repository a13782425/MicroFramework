...
namespace MFramework.Core.Editor
{
    internal sealed class MicroEditorWindow : EditorWindow
    {
        ...
        public VisualSplitter splitter { get; private set; }
        ...
        private void m_delayEnable()
        {
            ...
            splitter = new VisualSplitter();
            this.rootVisualElement.Add(splitter);
            ...
            splitter.Add(leftPane);
            splitter.Add(rightPane);
            _microLayoutModels.AddRange(MicroContextEditor.GetMicroLayouts());
            MicroContextEditor.CheckConfig();
