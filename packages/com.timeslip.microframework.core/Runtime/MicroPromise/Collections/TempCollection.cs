...
namespace MFramework.Core.Collections
{
    /// <summary>
    ...
    public readonly partial struct TempCollection<T> : IReadOnlyList<T>
    {
        ...
        /// <exception cref="PromiseInvalidOperationException">This instance is no longer valid.</exception>
        ...
        /// <exception cref="PromiseArgumentNullException"><paramref name="array"/> is null.</exception>
        /// <exception cref="PromiseArgumentOutOfRangeException"><paramref name="arrayIndex"/> is less than 0.</exception>
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            /// </summary>
            /// <exception cref="PromiseInvalidOperationException">The collection is no longer valid.</exception>
            public T Current
            {
                [MethodImpl(Internal.InlineOption)]
    ...
    internal sealed class TempCollectionDisposedChecker : Internal.ITraceable
    {
        ...
        ~TempCollectionDisposedChecker()
        {
            if (!_isDisposed)
            {
                Internal.ReportRejection(new PromiseUnreleasedObjectException("A TempCollectionDisposedChecker was garbage collected without being disposed."), this);
            }
        }
    }
    ...
    internal struct TempCollectionBuilder<T> : IDisposable
    {
        ...
        internal void ValidateAccess()
        {
            ...
            {
                throw new PromiseInvalidOperationException("TempCollection is invalid.", Internal.GetFormattedStacktrace(2));
            }
        }
#endif // PROMISE_DEBUG || PROTO_PROMISE_DEVELOPER_MODE
