using MFramework.Core.Collections;
using System;
    ...
    partial class Internal
    {
        ...
        internal sealed class ProgressMultiHandler : ProgressBase
        {
            ...
            ~ProgressMultiHandler()
            {
                if (!_disposed)
                {
                    ReportRejection(new PromiseUnreleasedObjectException("A Progress.MultiHandler's resources were garbage collected without it being disposed."), this);
                }
            }
