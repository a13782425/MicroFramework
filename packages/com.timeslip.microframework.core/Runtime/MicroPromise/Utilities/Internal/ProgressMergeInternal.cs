    ...
    partial class Internal
    {
        ...
        internal sealed class ProgressMerger : ProgressBase
        {
            ...
            ~ProgressMerger()
            {
                if (!_disposed)
                {
                    ReportRejection(new PromiseUnreleasedObjectException("A Progress.MergeBuilder's resources were garbage collected without it being disposed."), this);
                }
            }
            ...
            private sealed class MergeToken : ProgressBase
            {
                ...
                ~MergeToken()
                {
                    if (!_disposed)
                    {
                        ...
                        ReportRejection(new PromiseUnreleasedObjectException("A MergeToken was garbage collected without it being disposed."), this);
                    }
                }
