...
namespace MFramework.Core.CompilerServices
{
#if !NETCOREAPP
    ...
    public readonly partial struct ConfiguredPromiseAwaiterVoid : ICriticalNotifyCompletion, Internal.IPromiseAwaiter
    {
        ...
        /// <exception cref="PromiseInvalidOperationException">The <see cref="Promise"/> has already been awaited or forgotten.</exception>
        ...
        /// <remarks>This property is intended for compiler use rather than use directly in code.</remarks>
        /// <exception cref="PromiseInvalidOperationException">The <see cref="Promise"/> has already been awaited or forgotten, or it has not yet completed.</exception>
        [MethodImpl(Internal.InlineOption)]
    ...
    public readonly partial struct ConfiguredPromiseAwaiter<T> : ICriticalNotifyCompletion, Internal.IPromiseAwaiter
    {
        ...
        /// <remarks>This property is intended for compiler use rather than use directly in code.</remarks>
        /// <exception cref="PromiseInvalidOperationException">The <see cref="Promise{T}"/> has already been awaited or forgotten.</exception>
        public bool IsCompleted
            => _continuationOptions.GetShouldContinueImmediately()
            && _promise._ref?.GetIsCompleted(_promise._id) != false;
        ...
        /// <remarks>This property is intended for compiler use rather than use directly in code.</remarks>
        /// <exception cref="PromiseInvalidOperationException">The <see cref="Promise{T}"/> has already been awaited or forgotten, or it has not yet completed.</exception>
        [MethodImpl(Internal.InlineOption)]
        public T GetResult()
        {
            var _ref = _promise._ref;
