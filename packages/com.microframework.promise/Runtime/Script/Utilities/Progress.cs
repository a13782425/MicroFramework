...
namespace MFramework.Promise
{
    ...
    public readonly partial struct Progress
    {
        ...
        public readonly struct MergeBuilder : IDisposable
        {
            ...
            /// <returns>A new progress token.</returns>
            /// <exception cref="ObjectDisposedException">This instance was already disposed.</exception>
            /// <exception cref="PromiseArgumentOutOfRangeException"><paramref name="weight"/> is not greater than 0.</exception>
            ...
            public ProgressToken NewToken(double weight = 1d)
            {
                ...
                if (!(weight > 0))
                {
                    throw new PromiseArgumentOutOfRangeException(nameof(weight), "weight must be greater than 0", Internal.GetFormattedStacktrace(1));
                }
                var impl = _impl;
    ...
    public readonly struct ProgressToken : IProgress<double>
    {
        ...
        /// </remarks>
        /// <exception cref="PromiseArgumentOutOfRangeException">The <paramref name="value"/> is not between 0 and 1 inclusive.</exception>
        ...
        /// <exception cref="PromiseArgumentOutOfRangeException"><paramref name="minValue"/> or <paramref name="maxValue"/> are not between 0 and 1 inclusive.</exception>
