...
namespace MFramework.Promise
{
    ...
    internal static partial class Internal
    {
        ...
        internal static void ReportUnhandledException(PromiseUnhandledException exception)
        {
#if PROTO_PROMISE_DEVELOPER_MODE
            ...
            Action<PromiseUnhandledException> handler = Promise.Config.UncaughtRejectionHandler;
            if (handler != null)
            {
            ...
            {
                synchronizationContext.Post(e => { throw (PromiseUnhandledException) e; }, exception);
            }
            else
            {
                ThreadPool.QueueUserWorkItem(e => { throw (PromiseUnhandledException) e; }, exception);
            }
        }
