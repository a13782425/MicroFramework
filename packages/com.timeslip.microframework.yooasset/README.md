...
<root>
  ...
  ├── Editor
  │   ├── JunyangGao.MframeworkYooasset.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── JunyangGao.MframeworkYooasset.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── JunyangGao.MframeworkYooasset.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── JunyangGao.MframeworkYooasset.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `JunyangGao.MframeworkYooasset`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package MFramework.YooAsset Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/JunyangGao.MframeworkYooasset.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/JunyangGao.MframeworkYooasset.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/JunyangGao.MframeworkYooasset.Editor.Tests.asmdef`

  `Tests/Runtime/JunyangGao.MframeworkYooasset.Tests.asmdef`
...
Use the `Documentations~/MFramework.YooAsset.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
